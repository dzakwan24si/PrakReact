        ...
        <div className="flex min-h-screen w-90 flex-col bg-white p-10 shadow-lg">
            ...
            <div className="mt-10">
                <ul className="space-y-3">
                    <li>
                        <Link to="/" className="hover:text-hijau flex cursor-pointer items-center rounded-xl p-4 font-medium text-gray-600 hover:bg-green-200 hover:font-extrabold">
                            <MdSpaceDashboard className="mr-4 text-xl" /> Dashboard
                        </Link>
                    </li>
                    <li>
                        <Link to="/orders" className="hover:text-hijau flex cursor-pointer items-center rounded-xl p-4 font-medium text-gray-600 hover:bg-green-200 hover:font-extrabold">
                            <IoIosList className="mr-4 text-xl" /> Orders
                        </Link>
                    </li>
                    <li>
                        <Link to="/customers" className="hover:text-hijau flex cursor-pointer items-center rounded-xl p-4 font-medium text-gray-600 hover:bg-green-200 hover:font-extrabold">
